...
You need to install NodeJS on your computer before you can use "**Desafio: Conceitos do React Native**". You can install NodeJS by following <a href="https://nodejs.org/en/download/package-manager/">these instructions</a>.
...
You need to configure React Native environment on your computer before you can use "**Desafio: Conceitos do React Native**".
...
Now you can use "**Desafio: Conceitos do React Native**".
...
This project is licensed under the MIT License - see the <a href="https://github.com/matheusleandroo/desafio-conceitos-react-native/blob/master/LICENSE">LICENSE.md</a> file for details.
